...
OUTCOME_COLUMNS = [
    ("vacancies_q100", "Vacancies (Percentile)"),
...
def build_table(data: dict) -> str:
    ...
    lines.append("\\caption{Core Vacancy Outcomes — Combined (Percentile Rank)}")
...
def main():
    ...
    ap.add_argument("--output-tex", type=Path, default=Path("results/final/tex/vacancy_workflow/core_combined_table_q100.tex"))
    args = ap.parse_args()
