#!/usr/bin/env python3
"""
Format composition results into LaTeX tables - Fixed version
Shows interaction effects properly
"""
import pandas as pd
import numpy as np
...
def create_role_table():
    ...
    # Read role results
    df = pd.read_csv('/Users/saul/Dropbox/Remote Work Startups/main/results/raw/user_productivity_composition/role_composition_share_results.csv')
...
"""
    ...
    # Panel A: OLS - Remote × Post (same for all specs)
    ...
    # Panel A: OLS - Remote × Post × Startup (same for all specs)
...
def create_seniority_table():
    ...
    df = pd.read_csv('/Users/saul/Dropbox/Remote Work Startups/main/results/raw/user_productivity_composition/seniority_composition_share_results.csv')
...
if __name__ == "__main__":
    ...
    # Write to file
    output_file = "/Users/saul/Dropbox/Remote Work Startups/main/writeup/composition_effects_fixed.tex"
