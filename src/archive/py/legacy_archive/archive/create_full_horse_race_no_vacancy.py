#!/usr/bin/env python3
"""
Create LaTeX table for horse race specifications WITHOUT vacancy column
"""
...
# Remove the vacancy row (index 3)
summary_df = summary_df[summary_df.index != 3].reset_index(drop=True)

print("\nSummary data (without vacancy):")
print(summary_df)
...
\toprule
 & (1) & (2) & (3) & (4) & (5) \\
 & Baseline & Endogenous & Exogenous & Rent & HHI \\
 & & Growth & Growth & & \\
\midrule
Remote $\times$ COVID & """
...
# Write LaTeX file
output_file = f"{clean_results_dir}/horse_race_full_no_vacancy.tex"
...
standalone_file = f"{clean_results_dir}/horse_race_full_no_vacancy_standalone.tex"
...
print(f"4. HHI is the main source of heterogeneity: {summary_df.loc[4, 'var5_int_coef']:.3f} pp")