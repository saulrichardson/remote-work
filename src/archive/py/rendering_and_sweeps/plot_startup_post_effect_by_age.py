...
from src.py.project_paths import DATA_PROCESSED, RESULTS_CLEANED_FIGURES, ensure_dir, relative_to_project
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output",
        type=str,
        default=str(RESULTS_CLEANED_FIGURES / "startup_post_effect_by_age.png"),
