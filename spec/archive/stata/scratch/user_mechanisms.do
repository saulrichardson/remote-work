...
*============================================================*
* user_mechanisms.do
* Builds the mechanism table that layers rent, market concentration, seniority,
* and wage-growth controls onto the core user-productivity IV design.  Using the
* selected user panel (default: precovid), we estimate OLS and 2SLS models with
* firm-by-user and time fixed effects, instrument remote adoption with the
* teleworkability index, and report first-stage strength for each specification.
*============================================================*
...
* tables/figures always document the underlying sample.
*---------------------------------------------------------------------------*

local specname   "user_mechanisms_`panel_variant'"
capture log close
cap mkdir "$LOG_DIR"
