...
di as result "=== Growth residualization regression ==="
reghdfe growth_rate_we_post_c ind_growth_postavg_lo msa_growth_postavg_lo tile_rent tile_hhi, resid

di as result "=== Creating residualized growth tiles ==="
...
di as result "=== Merge results for residualized growth ==="
tab _merge
...
di as result "=== Final IV regression with residualized growth ==="
ivreghdfe total_contributions_q100 (var3 var5 = var6 var7) var4 var17 var18, ///
