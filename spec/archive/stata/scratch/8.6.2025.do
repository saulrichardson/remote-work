...
collapse (last) tile_growth_resid (last) ind_growth_postavg_lo (last) msa_growth_postavg_lo (last) tile_rent (last) tile_hhi, by(companyname)
...
gen var18 = covid*tile_growth_resid*remote
...
gen var17_ind = covid*ind_growth_postavg_lo
gen var18_ind = covid*ind_growth_postavg_lo*startup
gen var17_msa = covid*msa_growth_postavg_lo
gen var18_msa = covid*msa_growth_postavg_lo*startup
gen var17_rent = covid*tile_rent
gen var18_rent = covid*tile_rent*startup
gen var17_hhi = covid*tile_hhi
gen var18_hhi = covid*tile_hhi*startup




reghdfe total_contributions_q100 var3 var5 var4 var17_rent var18_rent var17_hhi var18_hhi, ///
    absorb(firm_id#user_id yh) vce(cluster user_id)
	
ivreghdfe total_contributions_q100 (var3 var5 = var6 var7) var4 var17_rent var18_rent var17_hhi var18_hhi, ///
    absorb(firm_id#user_id yh) vce(cluster user_id)

	reghdfe total_contributions_q100 var3 var5 var4 var17_msa var18_msa , ///
    absorb(firm_id#user_id yh) vce(cluster user_id)
	
ivreghdfe total_contributions_q100 (var3 var5 = var6 var7) var4 var17_msa var18_msa, ///
    absorb(firm_id#user_id yh) vce(cluster user_id)
	

reghdfe total_contributions_q100 var3 var5 var4 var17_ind var18_ind var17_msa var18_msa var17_rent var18_rent, ///
    absorb(firm_id#user_id yh) vce(cluster user_id)
	
ivreghdfe total_contributions_q100 (var3 var5 = var6 var7) var4 var17_ind var18_ind var17_msa var18_msa  var17_rent var18_rent, ///
    absorb(firm_id#user_id yh) vce(cluster user_id)
