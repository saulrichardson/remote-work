...
capture log close
cap mkdir "$LOG_DIR"
log using "$LOG_DIR/het_modal_base.log", replace text




*----------------------------------------------------------------------
* heterogeneity_modal_base.do  — IV and OLS split by modal-MSA status
*   base controls:  var3  var4
*   Outputs:
*     - IV  stats -> var5_modal_base.csv (existing filename retained)
*     - OLS stats -> var5_modal_base_ols.csv (new parallel output)
*----------------------------------------------------------------------
* ---------------------------------------------------------------------
