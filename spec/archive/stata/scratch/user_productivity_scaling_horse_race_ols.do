...
*====================================================================*
*  spec/user_productivity_scaling_horse_race_ols.do
*  ------------------------------------------------------------------
*  OLS version of the horse race specification (no instruments)
*  All 6 columns:
...
*--------------------------------------------------------------------*
* Run all OLS specifications (using reghdfe instead of ivreghdfe)
*--------------------------------------------------------------------*
eststo clear

* Specification 1: Baseline (no interactions)
eststo spec1: reghdfe total_contributions_q100 ///
    var3 var5 var4 ///
...
eststo spec2: reghdfe total_contributions_q100 ///
    var3 var5 var3_growth var5_growth ///
...
eststo spec3: reghdfe total_contributions_q100 ///
    var3 var5 var3_exo var5_exo ///
...
eststo spec4: reghdfe total_contributions_q100 ///
    var3 var5 var3_exov var5_exov ///
...
eststo spec5: reghdfe total_contributions_q100 ///
    var3 var5 var3_rent var5_rent ///
    var4 high_rent ///
    , absorb(firm_id#user_id yh) ///
    vce(cluster user_id)
...
eststo spec6: reghdfe total_contributions_q100 ///
    var3 var5 var3_hhi var5_hhi ///
    var4 high_hhi ///
    , absorb(firm_id#user_id yh) ///
    vce(cluster user_id)
...
*--------------------------------------------------------------------*
* Full results
esttab spec1 spec2 spec3 spec4 spec5 spec6 using "$results/scaling_horse_race_ols.csv", ///
    replace ///
...
file open summary using "$results/horse_race_ols_summary.csv", write replace
...
di _n "=== OLS RESULTS EXPORTED ==="
di "Full results: $results/scaling_horse_race_ols.csv"
di "Summary: $results/horse_race_ols_summary.csv"