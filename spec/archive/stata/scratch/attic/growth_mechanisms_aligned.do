...
*====================================================================*
*  spec/growth_mechanisms_aligned.do
*  ------------------------------------------------------------------
*  Aligned with user_productivity_expost_growth_loop.do approach
*  Tests baseline, endogenous (raw), and exogenous (residualized) growth
*====================================================================*
...
local specname "growth_mechanisms_aligned_`panel_variant'"
capture log close
cap mkdir "$LOG_DIR"
...
* This matches line 281 of original script (using reg instead of reghdfe)
reg growth_rate_we_post_c ind_growth_postavg_lo msa_growth_postavg_lo tile_rent tile_hhi

predict growth_resid

* Create EXOGENOUS growth tile (residualized)
...
* Exogenous growth interactions (residualized)
...
* Specification 3: Exogenous Growth (residualized tiles)
