*====================================================================*
*  spec/user_mechanisms_post_control_baseline.do
*  ------------------------------------------------------------------
*  Worker-level mechanisms table with separate worker, firm, and
*  half-year fixed effects. Competing channels enter as post-period
*  controls, matching the paper's seven-column control sequence.
*
*  Equity support rule:
...
local specname   "user_mechanisms_post_control_baseline_`panel_variant'"
...
gen var19 = covid*eq_any_firm
gen var20 = covid*eq_any_firm*startup
...
foreach s in `specs' {
    ...
    if "`s'" == "baseline" {
        ...
        local OLS_RHS  "var3 var5 var4 var17_e var18_e"
        local IV_ENDO  "var3 var5"
        local IV_INSTR "var6 var7"
        local IV_EXOG  "var4 var17_e var18_e"
    }
    else if "`s'" == "equity" {
        local OLS_RHS  "var3 var5 var4 var19 var20"
        local IV_ENDO  "var3 var5"
        local IV_INSTR "var6 var7"
        local IV_EXOG  "var4 var19 var20"
    }
    else if "`s'" == "growth_endog_equity" {
        local OLS_RHS  "var3 var5 var4 var17_e var18_e var19 var20"
        local IV_ENDO  "var3 var5"
        local IV_INSTR "var6 var7"
        local IV_EXOG  "var4 var17_e var18_e var19 var20"
    }
    else if "`s'" == "hhi" {
        local OLS_RHS  "var3 var5 var4 var11 var12"
        local IV_ENDO  "var3 var5"
        local IV_INSTR "var6 var7"
        local IV_EXOG  "var4 var11 var12"
    }
    else if "`s'" == "seniority" {
        local OLS_RHS  "var3 var5 var4 var14 var15"
        local IV_ENDO  "var3 var5"
        local IV_INSTR "var6 var7"
        local IV_EXOG  "var4 var14 var15"
    }
    else if "`s'" == "hhi_seniority" {
        local OLS_RHS  "var3 var5 var4 var11 var12 var14 var15"
        local IV_ENDO  "var3 var5"
        local IV_INSTR "var6 var7"
        local IV_EXOG  "var4 var11 var12 var14 var15"
    }
