*====================================================================*
* user_productivity_equity_quadruple_pair_fe.do
*
* Pair-FE equity quadruple specification.
*
* The baseline spec is:
*   y = var3 + var5 + var4 + FE
*
* The quadruple spec appends the equity signal to the core empirical
* setup:
*   var3_eq = var3 x equity
*   var4_eq = var4 x equity
*   var5_eq = var5 x equity
*   var6_eq = var6 x equity
*   var7_eq = var7 x equity
*
* Output:
*   results/raw/user_productivity_equity_quadruple_pair_fe_<variant>/consolidated_results.csv
*====================================================================*
...
local specname "user_productivity_equity_quadruple_pair_fe_`panel_variant'"
capture log close
cap mkdir "$LOG_DIR"
log using "$LOG_DIR/`specname'.log", replace text

tempfile equity_by_firm panel_ready

* 1) Build strict any-equity firm signal.
...
* 2) Load user panel and merge controls.
