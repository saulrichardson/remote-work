*====================================================================*
* user_productivity_equity_quadruple_postings_coverage.do
*
* Baseline-FE equity quadruple specification with postings-based
* equity coverage.
*
* Main sample rule:
...
*
* Output:
*   results/raw/user_productivity_equity_quadruple_postings_coverage_<variant>/consolidated_results.csv
*====================================================================*
...
local specname "user_productivity_equity_quadruple_postings_coverage_`panel_variant'"
capture log close
cap mkdir "$LOG_DIR"
