*============================================================*
* firm_scaling_llm_equity_pi_followups.do
*
...
*
* Output:
*   results/raw/firm_scaling_llm_equity_pi_followups/consolidated_results.csv
*============================================================*

args enriched_panel_csv
...
local specname "firm_scaling_llm_equity_pi_followups"
capture log close
cap mkdir "$LOG_DIR"
log using "$LOG_DIR/`specname'.log", replace text

* 1) Build analysis panel: baseline firm panel + enriched LLM signals
