*====================================================================*
* user_horse_race_startup_swapped_pair_fe_postings_coverage.do
*
* Pair-FE horse-race extension with postings-based equity coverage.
*
* Main sample rule:
...
*
* The growth channel is harmonized with the baseline-FE and mechanisms
...
*
* Output:
*   results/raw/user_horse_race_startup_swapped_pair_fe_postings_coverage_<variant>/consolidated_results.csv
*====================================================================*
...
local specname "user_horse_race_startup_swapped_pair_fe_postings_coverage_`panel_variant'"
capture log close
cap mkdir "$LOG_DIR"
