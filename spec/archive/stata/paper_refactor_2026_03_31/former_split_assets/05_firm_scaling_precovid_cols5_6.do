*============================================================*
* Asset 05: firm_scaling_precovid_cols5_6.tex
* Self-contained vacancy-outcome export for the active scaling table.
* Writes only the vacancy outcomes used by the active paper asset.
*============================================================*
...
local specname   "05_firm_scaling_precovid_cols5_6"
capture log close
cap mkdir "$LOG_DIR"
...
/*
Outcomes used by the active paper table:
 - vacancies_thousands
 - hires_to_vacancies_winsor95_min3
 - any_vacancy
*/
...
// 4) Loop over the vacancy outcomes used by the active paper table
local outcome_vars vacancies_thousands hires_to_vacancies_winsor95_min3 any_vacancy
