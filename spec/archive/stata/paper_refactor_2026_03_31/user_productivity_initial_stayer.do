*============================================================*
*  user_productivity_initial_stayer.do
*  Baseline IV/OLS spec (no startup interaction) run on the
*  boundary-stayer sample (same firm pre/post, single spell).
*============================================================*

* Parse variant argument ----------------------------------------------------
args panel_variant
if "`panel_variant'" == "" local panel_variant "precovid"
local specname user_productivity_initial_`panel_variant'_stayer
...
// 1a) Identify boundary stayers (reuse logic from user_productivity_stayer.do)
sort user_id y half
...
* Keep boundary stayers and only the spell spanning the boundary
...
// Outcomes needed for Table 2/3 layout
