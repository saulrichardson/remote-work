*============================================================*
* user_productivity_firmbyuser.do
* Generates the user-level regressions with firm×individual FE that quantify how firms'
...
local specname user_productivity_firmbyuser_`panel_variant'
...
foreach y of local outcomes {
    ...
    ivreghdfe ///
        ...
        absorb(firm_id#user_id yh) cluster(user_id) savefirst
