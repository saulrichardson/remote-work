*============================================================*
* user_productivity_startup_cutoff_sweep.do
* Runs the baseline user-level OLS specification while sweeping
* across alternative startup age cutoffs (5/7/10/12 years). The
* script rewrites the startup interaction terms on the fly so the
* downstream parameter names (var3, var5, var4) stay unchanged.
*============================================================*

* --------------------------------------------------------------------------
* 0) Parse optional variant argument (default: precovid)
* --------------------------------------------------------------------------
args panel_variant
if "`panel_variant'" == "" local panel_variant "precovid"
local specname user_productivity_startup_cutoff_sweep_`panel_variant'
...
foreach cutoff of local cutoffs {
    di as text "→ Running OLS with startup cutoff <= `cutoff' years"
    preserve
