*============================================================*
* Narrow support helper for the main firm scaling growth/join/
* leave specification.
*============================================================*

args specname result_subdir model_mode
if "`specname'" == "" local specname "firm_scaling_growth_split_single_scope"
if "`result_subdir'" == "" {
    di as error "run_firm_scaling_growth_split_single_scope.do requires result_subdir"
    exit 198
}
