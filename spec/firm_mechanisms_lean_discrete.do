...
capture log close
cap mkdir "log"
local specname   "firm_mechanisms_lean_`treat'"
...
// 6) Build spec-specific macros (OLS exog, IV exog, instruments, endogenous)
