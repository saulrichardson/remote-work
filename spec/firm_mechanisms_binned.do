*============================================================*
*  firm_mechanisms_binned.do
*  — Firm-level mechanisms script with continuous variables
*    converted to High/Low dummies (median split).
*============================================================*

capture log close
cap mkdir "log"

local specname "firm_mechanisms_binned"
...
// ---------------------------------------------------------------------
// 2) Load firm panel & binarise mechanisms
// ---------------------------------------------------------------------
...
// ---------------------------------------------------------------------
// 3) Create interactions (same as original script)
// ---------------------------------------------------------------------
...
// ---------------------------------------------------------------------
// 4) Postfile setup & spec list (copy from original)
// ---------------------------------------------------------------------
...
// ---------------------------------------------------------------------
// 5) Spec matrices (identical to original)
// ---------------------------------------------------------------------
