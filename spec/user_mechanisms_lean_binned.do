*============================================================*
*  user_mechanisms_lean_binned.do
*  — Lean horse-race (only 2-way interactions) with mechanisms
*    binarised at sample medians.
*============================================================*

capture log close
cap mkdir "log"

* 0) Panel variant argument (default: precovid, to mirror original lean script)
args panel_variant
if "`panel_variant'" == "" local panel_variant "precovid"

local specname "user_mechanisms_lean_binned_`panel_variant'"
