...
*     (built by python src/py/build_firm_panel_with_crunchbase_funding.py)
*
* Outputs
...
local specname "03_firm_scaling_crunchbase_fundraising_core4"
capture log close
cap mkdir "$LOG_DIR"
...
foreach y of local outcomes {
    ...
    ivreghdfe `y' (var3 = var6), absorb(firm_id_num yh_num) vce(cluster firm_id_num)
    local rkf = e(rkf)
    local N = e(N)
