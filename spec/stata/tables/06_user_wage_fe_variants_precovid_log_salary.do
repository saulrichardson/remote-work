...
* in the productivity analysis, and exports the second-stage results for the
* active wage table. The exported FE variants align
...
local specname 06_user_wage_fe_variants_`panel_variant'_log_salary
