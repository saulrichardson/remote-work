*============================================================*
* Asset 09: user_event_study_fullrem_precovid_ols.png
*============================================================*

args panel_variant
if "`panel_variant'" == "" local panel_variant "precovid"
local asset_stem "09_user_event_study_fullrem_`panel_variant'_ols"
...
reghdfe `outcome' `rem_vars' `rem_start_vars' `startup_vars', absorb(user_id firm_id yh) vce(cluster user_id)
...
preserve
    ...
    export delimited using "`result_dir'/ols_total_contributions_q100.csv", replace
restore
