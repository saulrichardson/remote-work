*============================================================*
* Asset 03: startup_cutoff_bars_total_contributions_q100.png
* Self-contained user startup-cutoff sweep.
*============================================================*

args panel_variant
if "`panel_variant'" == "" local panel_variant "precovid"

local asset_stem "03_startup_cutoff_bars_total_contributions_q100"
...
local result_dir "`result_root'/user_productivity"
...
foreach cutoff of local cutoffs {
    ...
    foreach y of local outcomes {
        ...
        ivreghdfe `y' (var3 var5 = var6 var7) var4, ///
            absorb(user_id firm_id yh) cluster(user_id)
        local rkf = e(rkf)
        local N = e(N)
        local coeffs : colnames e(b)
