*============================================================*
* Asset 12: firm_event_study_fullrem_leave_rate_ols.png
*============================================================*

local asset_stem "12_firm_event_study_fullrem_leave_rate_ols"
local outcome "leave_rate_we"
...
preserve
    ...
    export delimited using "`result_dir'/ols_leave_rate_we.csv", replace
restore
