*============================================================*
* Asset 10: firm_event_study_fullrem_growth_ols.png
*============================================================*

local asset_stem "10_firm_event_study_fullrem_growth_ols"
...
preserve
    ...
    export delimited using "`result_dir'/ols_growth_rate_we.csv", replace
restore
