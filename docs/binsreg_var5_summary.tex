...
\end{verbatim}
    where \texttt{treat\_var5 = (var5 > 0)} flags remote $\times$ COVID exposure for startups. The command exports both a Stata figure (\texttt{results/cleaned/figures/binsreg\_var5\_levels\_simple.png}) and the underlying dataset (\texttt{results/raw/binsreg\_var5\_levels.dta}) for post-processing.
\end{enumerate}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.85\textwidth]{../results/cleaned/figures/effect_var5_age_python.png}
