...
This workflow is archived. It is not part of the current paper-owned lane, and
the scripts it uses now live under `src/archive/py/nonpaper_builders/`.
...
|-----------|-------------|
| `data/clean/linkedin_panel.parquet` | Half-year spells of LinkedIn workers (built by `src/archive/py/nonpaper_builders/build_linkedin_panel_duckdb.py`). |
...
--------------------------------------------------------------------
Script: **`src/archive/py/nonpaper_builders/build_firm_occ_tightness.py`**
...
--------------------------------------------------------------------
Script: **`src/archive/py/nonpaper_builders/build_firm_panel.py`** (2025-07 revision)
...
python3 src/archive/py/nonpaper_builders/build_firm_occ_tightness.py

# Build firm-level panel *and* the static tightness CSV
python3 src/archive/py/nonpaper_builders/build_firm_panel.py
```
