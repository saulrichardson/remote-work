...
Usage
-----
python scripts/simple_table_from_consolidated.py \
...
def main(argv: list[str] | None = None) -> None:
    ...
    p.add_argument("--out",     type=Path, default=None, help="Destination .tex file (defaults to results/cleaned/<spec>.tex)")
    ...
    if args.out is not None:
        ...
        out_path = spec_dir.parents[1] / "cleaned" / f"{spec_name}.tex"  # results/cleaned/
