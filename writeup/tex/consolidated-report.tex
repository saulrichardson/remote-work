...
\input{\cleanedresultsdir/user_productivity_balanced_pre_ols.tex}
...
\input{\cleanedresultsdir/user_productivity_balanced_pre_iv.tex}
...
\input{\cleanedresultsdir/user_productivity_balanced_pre_first_stage.tex}
% -------------------------------------------------------------------------
% Mechanisms
% -------------------------------------------------------------------------
...
\input{\cleanedresultsdir/user_mechanisms_unbalanced.tex}
\end{landscape}

\begin{landscape}
\subsection{User Mechanisms -- Balanced Panel}
\input{\cleanedresultsdir/user_mechanisms_balanced.tex}
\end{landscape}
...
\input{\cleanedresultsdir/user_mechanisms_lean_unbalanced.tex}
\end{landscape}

\begin{landscape}
\subsection{User Mechanisms (Lean) -- Balanced Panel}
\input{\cleanedresultsdir/user_mechanisms_lean_balanced.tex}
\end{landscape}
