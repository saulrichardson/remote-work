#!/usr/bin/env python3
"""Build the active startup-cutoff figure for contribution rank."""
...
CI_Z = 1.96
INPUT_CSV = (
    RESULTS_RAW / "03_startup_cutoff_bars_total_contributions_q100" / "user_productivity" / "consolidated_results.csv"
)
OUTPUT = RESULTS_CLEANED_FIGURES / "startup_cutoff_bars_total_contributions_q100.png"
