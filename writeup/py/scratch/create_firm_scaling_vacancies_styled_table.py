...
Outputs two TeX files to results/final/tex/ for OLS and IV with eight columns:
  Growth, Growth, Join, Leave, Job Postings, Log Job Postings, Hires/Vacancies, Any Postings
"""
