...
# Project paths
from src.py.project_paths import RESULTS_RAW, RESULTS_CLEANED_FIGURES, ensure_dir  # type: ignore  # noqa: E402
from writeup.py.plot_style import (  # type: ignore  # noqa: E402
    apply_mpl_defaults,
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--input",
        type=Path,
        default=RESULTS_RAW / "18_user_hire_event_study_remote_rank_mw" / "ols_results.csv",
