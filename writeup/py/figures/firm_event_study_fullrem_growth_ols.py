#!/usr/bin/env python3
"""Build the active full-remote firm growth event-study figure."""
...
apply_mpl_defaults()
INPUT = RESULTS_RAW / "10_firm_event_study_fullrem_growth_ols" / "ols_growth_rate_we.csv"
OUTPUT = RESULTS_CLEANED_FIGURES / "firm_event_study_fullrem_growth_ols.png"
YLABEL = "Change in firm growth rate"
