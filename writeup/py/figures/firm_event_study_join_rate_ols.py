#!/usr/bin/env python3
"""Build the active firm join-rate event-study figure."""
...
INPUT = RESULTS_RAW / "05_firm_event_study_join_rate_ols" / "ols_join_rate_we.csv"
OUTPUT = RESULTS_CLEANED_FIGURES / "firm_event_study_join_rate_ols.png"
