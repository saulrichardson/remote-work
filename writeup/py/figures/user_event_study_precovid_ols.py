#!/usr/bin/env python3
"""Build the active user precovid event-study figure."""
...
INPUT = RESULTS_RAW / "01_user_event_study_precovid_ols" / "ols_total_contributions_q100.csv"
OUTPUT = RESULTS_CLEANED_FIGURES / "user_event_study_precovid_ols.png"
