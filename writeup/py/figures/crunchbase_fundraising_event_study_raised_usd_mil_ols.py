#!/usr/bin/env python3
"""Build the active Crunchbase fundraising event-study figure."""
...
apply_mpl_defaults()
INPUT = RESULTS_RAW / "15_crunchbase_fundraising_event_study_raised_usd_mil_ols" / "ols_cb_raised_usd_mil.csv"
OUTPUT = RESULTS_CLEANED_FIGURES / "crunchbase_fundraising_event_study_raised_usd_mil_ols.png"
YLABEL = "Change in USD raised (mil)"
