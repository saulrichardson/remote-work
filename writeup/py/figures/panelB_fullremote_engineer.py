#!/usr/bin/env python3
"""Build the active engineer IRF panel."""
...
INPUT = RESULTS_RAW / "16_panelB_fullremote_engineer" / "remote1" / "eng_noneng_irf_results.csv"
LIMIT = RESULTS_RAW / "17_panelB_fullremote_nonengineer" / "remote1" / "eng_noneng_irf_results.csv"
OUTPUT = RESULTS_CLEANED / "irfs" / "user_irfs_eng_vs_noneng_remote_hybrid" / "panelB_fullremote_engineer.png"
