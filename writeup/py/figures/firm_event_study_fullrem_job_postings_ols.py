#!/usr/bin/env python3
"""Build the active full-remote firm job-postings event-study figure."""
...
apply_mpl_defaults()
INPUT = RESULTS_RAW / "13_firm_event_study_fullrem_job_postings_ols" / "ols_vacancies_thousands.csv"
OUTPUT = RESULTS_CLEANED_FIGURES / "firm_event_study_fullrem_job_postings_ols.png"
YLABEL = "Change in job postings"
