#!/usr/bin/env python3
"""Build the active user full-remote precovid event-study figure."""
...
apply_mpl_defaults()
INPUT = RESULTS_RAW / "09_user_event_study_fullrem_precovid_ols" / "ols_total_contributions_q100.csv"
OUTPUT = RESULTS_CLEANED_FIGURES / "user_event_study_fullrem_precovid_ols.png"
YLABEL = "Change in contribution rank"
