#!/usr/bin/env python3
"""Build the active full-remote firm join-rate event-study figure."""
...
apply_mpl_defaults()
INPUT = RESULTS_RAW / "11_firm_event_study_fullrem_join_rate_ols" / "ols_join_rate_we.csv"
OUTPUT = RESULTS_CLEANED_FIGURES / "firm_event_study_fullrem_join_rate_ols.png"
YLABEL = "Change in join rate"
