#!/usr/bin/env python3
"""Build the active firm growth event-study figure."""
...
INPUT = RESULTS_RAW / "02_firm_event_study_growth_ols" / "ols_growth_rate_we.csv"
OUTPUT = RESULTS_CLEANED_FIGURES / "firm_event_study_growth_ols.png"
