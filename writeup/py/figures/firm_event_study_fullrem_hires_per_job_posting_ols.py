#!/usr/bin/env python3
"""Build the active full-remote firm hires-per-posting event-study figure."""
...
apply_mpl_defaults()
INPUT = RESULTS_RAW / "14_firm_event_study_fullrem_hires_per_job_posting_ols" / "ols_hires_to_vacancies_winsor.csv"
OUTPUT = RESULTS_CLEANED_FIGURES / "firm_event_study_fullrem_hires_per_job_posting_ols.png"
YLABEL = "Change in hires per posting"
