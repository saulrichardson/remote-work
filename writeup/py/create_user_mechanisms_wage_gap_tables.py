...
SPECNAME = "user_mechanisms_wage_gap"
INPUT_CSV = PROJECT_ROOT / "results" / "raw" / SPECNAME / "consolidated_results.csv"
OUTPUT_TEX = PROJECT_ROOT / "results" / "cleaned" / "user_mechanisms_wage_gap.tex"
...
def one_table(df_iv, df_ols, specs, idx):
    ...
    lines.append(rf"\caption{{User Mechanisms – Wage Dispersion (Part {idx})}}")
    ...
    lines.append(rf"\label{{tab:user_mechanisms_wage_gap_{idx}}}")
