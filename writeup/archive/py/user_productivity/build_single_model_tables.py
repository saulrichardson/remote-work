...
This mirrors the formatting used by ``build_baseline_table.py`` but splits
the combined Panel A/B layout into two separate tables so they can be
...
from project_paths import RESULTS_CLEANED_TEX
...
from build_panel_tables import load_user_productivity_results  # type: ignore
