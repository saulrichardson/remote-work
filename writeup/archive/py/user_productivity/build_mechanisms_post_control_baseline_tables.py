...
parser = argparse.ArgumentParser(description="Create post-control baseline-FE mechanisms latex table")
parser.add_argument(
    "--variant",
...
specname = f"user_mechanisms_post_control_baseline_{variant}"
input_csv = RESULTS_RAW / specname / "consolidated_results.csv"
output_tex_base = RESULTS_CLEANED_TEX / f"user_mechanisms_post_control_baseline_{variant}.tex"
output_tex_ols = RESULTS_CLEANED_TEX / f"user_mechanisms_post_control_baseline_{variant}_ols.tex"
output_tex_iv = RESULTS_CLEANED_TEX / f"user_mechanisms_post_control_baseline_{variant}_iv.tex"
...
write_mechanisms_tables(
    ...
    fe_row_labels=[r"Time", r"Firm", r"Individual"],
)
