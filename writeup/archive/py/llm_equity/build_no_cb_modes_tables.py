#!/usr/bin/env python3
"""Build LaTeX tables for the LLM-equity no-CB analysis package.
...
FIRM_RAW: Final[Path] = RESULTS_RAW / "firm_scaling_llm_equity_no_cb_modes" / "consolidated_results.csv"
USER_RAW: Final[Path] = RESULTS_RAW / "user_productivity_llm_equity_no_cb_modes_precovid" / "consolidated_results.csv"
SAMPLE_RAW: Final[Path] = RESULTS_RAW / "llm_equity_no_cb_modes" / "sample_accounting.csv"
SHARES_RAW: Final[Path] = RESULTS_RAW / "llm_equity_no_cb_modes" / "startup_vs_nonstartup_equity_shares.csv"
SHARES_RAW_LEGACY: Final[Path] = RESULTS_RAW / "llm_equity_no_cb_modes" / "startup_vs_large_equity_shares.csv"
INTENSIVE_RAW: Final[Path] = RESULTS_RAW / "llm_equity_no_cb_modes" / "intensive_margin_summary.csv"

OUT_SAMPLE: Final[Path] = RESULTS_CLEANED_TEX / "llm_equity_no_cb_modes_sample_accounting.tex"
OUT_DESC: Final[Path] = RESULTS_CLEANED_TEX / "llm_equity_no_cb_modes_descriptives.tex"

OUT_SAMPLE_BACKFILL: Final[Path] = RESULTS_CLEANED_TEX / "llm_equity_no_cb_backfill_sample_accounting.tex"
OUT_DESC_BACKFILL: Final[Path] = RESULTS_CLEANED_TEX / "llm_equity_no_cb_backfill_descriptives.tex"

OUT_FIRM_CORE_POOLED: Final[Path] = RESULTS_CLEANED_TEX / "llm_equity_no_cb_modes_firm_core_pooled.tex"
OUT_FIRM_SPLIT_NON_EQ: Final[Path] = RESULTS_CLEANED_TEX / "llm_equity_no_cb_modes_firm_core_split_non_equity.tex"
OUT_FIRM_SPLIT_EQ: Final[Path] = RESULTS_CLEANED_TEX / "llm_equity_no_cb_modes_firm_core_split_equity.tex"
OUT_FIRM_INTENSIVE_SHARE: Final[Path] = RESULTS_CLEANED_TEX / "llm_equity_no_cb_modes_firm_intensive_share.tex"
OUT_FIRM_INTENSIVE_COUNT_MEAN: Final[Path] = RESULTS_CLEANED_TEX / "llm_equity_no_cb_modes_firm_intensive_count_mean.tex"
OUT_FIRM_REDUCED1: Final[Path] = RESULTS_CLEANED_TEX / "llm_equity_no_cb_modes_firm_reduced1.tex"
OUT_FIRM_SIMPLE_DD: Final[Path] = RESULTS_CLEANED_TEX / "llm_equity_no_cb_modes_firm_simple_dd.tex"
OUT_FIRM_CONCENTRATION_ANY: Final[Path] = RESULTS_CLEANED_TEX / "llm_equity_no_cb_modes_firm_concentration_any.tex"
OUT_FIRM_CONCENTRATION_SHARE: Final[Path] = RESULTS_CLEANED_TEX / "llm_equity_no_cb_modes_firm_concentration_share.tex"
OUT_FIRM_CONCENTRATION_COUNT_MEAN: Final[Path] = RESULTS_CLEANED_TEX / "llm_equity_no_cb_modes_firm_concentration_count_mean.tex"

OUT_FIRM_CORE_POOLED_BACKFILL: Final[Path] = RESULTS_CLEANED_TEX / "llm_equity_no_cb_backfill_firm_core_pooled.tex"
OUT_FIRM_SPLIT_NON_EQ_BACKFILL: Final[Path] = RESULTS_CLEANED_TEX / "llm_equity_no_cb_backfill_firm_core_split_non_equity.tex"
OUT_FIRM_SPLIT_EQ_BACKFILL: Final[Path] = RESULTS_CLEANED_TEX / "llm_equity_no_cb_backfill_firm_core_split_equity.tex"

OUT_USER_CORE_POOLED: Final[Path] = RESULTS_CLEANED_TEX / "llm_equity_no_cb_modes_user_core_pooled.tex"
OUT_USER_SPLIT_NON_EQ: Final[Path] = RESULTS_CLEANED_TEX / "llm_equity_no_cb_modes_user_core_split_non_equity.tex"
OUT_USER_SPLIT_EQ: Final[Path] = RESULTS_CLEANED_TEX / "llm_equity_no_cb_modes_user_core_split_equity.tex"
OUT_USER_INTENSIVE_SHARE: Final[Path] = RESULTS_CLEANED_TEX / "llm_equity_no_cb_modes_user_intensive_share.tex"
OUT_USER_INTENSIVE_COUNT_MEAN: Final[Path] = RESULTS_CLEANED_TEX / "llm_equity_no_cb_modes_user_intensive_count_mean.tex"
OUT_USER_REDUCED1: Final[Path] = RESULTS_CLEANED_TEX / "llm_equity_no_cb_modes_user_reduced1.tex"
OUT_USER_SIMPLE_DD: Final[Path] = RESULTS_CLEANED_TEX / "llm_equity_no_cb_modes_user_simple_dd.tex"
OUT_USER_CONCENTRATION_ANY: Final[Path] = RESULTS_CLEANED_TEX / "llm_equity_no_cb_modes_user_concentration_any.tex"
OUT_USER_CONCENTRATION_SHARE: Final[Path] = RESULTS_CLEANED_TEX / "llm_equity_no_cb_modes_user_concentration_share.tex"
OUT_USER_CONCENTRATION_COUNT_MEAN: Final[Path] = RESULTS_CLEANED_TEX / "llm_equity_no_cb_modes_user_concentration_count_mean.tex"

OUT_USER_CORE_POOLED_BACKFILL: Final[Path] = RESULTS_CLEANED_TEX / "llm_equity_no_cb_backfill_user_core_pooled.tex"
OUT_USER_SPLIT_NON_EQ_BACKFILL: Final[Path] = RESULTS_CLEANED_TEX / "llm_equity_no_cb_backfill_user_core_split_non_equity.tex"
OUT_USER_SPLIT_EQ_BACKFILL: Final[Path] = RESULTS_CLEANED_TEX / "llm_equity_no_cb_backfill_user_core_split_equity.tex"
...
def main() -> None:
    ...
    for path, purpose in [
        (FIRM_RAW, "firm no-CB modes regression results"),
        (USER_RAW, "user no-CB modes regression results"),
        (SAMPLE_RAW, "no-CB modes sample accounting"),
        (shares_path, "no-CB modes startup/non-startup equity shares"),
        (INTENSIVE_RAW, "no-CB modes intensive margin summary"),
    ]:
