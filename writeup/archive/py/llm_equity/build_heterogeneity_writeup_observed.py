#!/usr/bin/env python3
"""Build a standalone LaTeX note for observed-only LLM-equity heterogeneity results."""
...
FIRM_TEX = RESULTS_CLEANED_TEX / "firm_scaling_llm_equity_heterogeneity_observed.tex"
USER_TEX = RESULTS_CLEANED_TEX / "user_productivity_llm_equity_heterogeneity_observed_precovid.tex"

OUT_TEX = PROJECT_ROOT / "writeup" / "tex" / "llm_equity_heterogeneity_observed_note.tex"
