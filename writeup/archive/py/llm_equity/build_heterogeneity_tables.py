#!/usr/bin/env python3
"""Build LaTeX tables for LLM-equity heterogeneity specs (firm + user)."""
...
FIRM_RAW: Final[Path] = RESULTS_RAW / "firm_scaling_llm_equity_heterogeneity" / "consolidated_results.csv"
USER_RAW: Final[Path] = RESULTS_RAW / "user_productivity_llm_equity_heterogeneity_precovid" / "consolidated_results.csv"

FIRM_OUT: Final[Path] = RESULTS_CLEANED_TEX / "firm_scaling_llm_equity_heterogeneity.tex"
USER_OUT: Final[Path] = RESULTS_CLEANED_TEX / "user_productivity_llm_equity_heterogeneity_precovid.tex"
