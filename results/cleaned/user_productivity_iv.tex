...
\addlinespace
     ...
     & (1) & (2) & (3) & (4) & (5) & (6) \\
    \midrule
    $ \text{Remote} \times \mathds{1}(\text{Post}) $ & \makecell[c]{-5.76\\(6.24)} & \makecell[c]{-7.15*\\(3.90)} & \makecell[c]{-9.26**\\(4.01)} & \makecell[c]{-5.11\\(5.27)} & \makecell[c]{-6.05\\(4.17)} & \makecell[c]{-11.55\\(8.14)} \\
...
MSA $\times$ Time FE &  &  &  &  & $\checkmark$ & $\checkmark$ \\
    \midrule
    N & 52,995 & 229,862 & 224,708 & 227,829 & 229,043 & 222,867 \\
KP rk Wald F & 102.60 & 140.60 & 123.43 & 109.16 & 130.48 & 49.49 \\
