...
\addlinespace
     ...
     & (1) & (2) & (3) & (4) & (5) & (6) \\
    \midrule
    $ \text{Remote} \times \mathds{1}(\text{Post}) $ & \makecell[c]{0.30\\(0.38)} & \makecell[c]{0.48\\(0.39)} & \makecell[c]{0.51\\(0.40)} & \makecell[c]{0.43\\(0.40)} & \makecell[c]{0.40\\(0.41)} & \makecell[c]{0.11\\(0.46)} \\
$ \text{Remote} \times \mathds{1}(\text{Post}) \times \text{Startup} $ &  & \makecell[c]{-3.56**\\(1.55)} & \makecell[c]{-3.72**\\(1.60)} & \makecell[c]{-3.84**\\(1.60)} & \makecell[c]{-3.47**\\(1.57)} & \makecell[c]{-3.50**\\(1.69)} \\
    \midrule
