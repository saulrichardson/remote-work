...
\addlinespace
     ...
     & (1) & (2) & (3) & (4) & (5) & (6) \\
    \midrule
    $ \text{Remote} \times \mathds{1}(\text{Post}) $ & \makecell[c]{-1.52*\\(0.92)} & \makecell[c]{-1.03**\\(0.48)} & \makecell[c]{-1.23**\\(0.50)} & \makecell[c]{-0.93*\\(0.49)} & \makecell[c]{-0.66\\(0.50)} & \makecell[c]{-0.50\\(0.55)} \\
