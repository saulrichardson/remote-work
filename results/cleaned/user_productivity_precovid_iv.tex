...
\addlinespace
     ...
     & (1) & (2) & (3) & (4) & (5) & (6) \\
    \midrule
    $ \text{Remote} \times \mathds{1}(\text{Post}) $ & \makecell[c]{-3.61\\(2.82)} & \makecell[c]{-7.15*\\(3.90)} & \makecell[c]{-9.26**\\(4.01)} & \makecell[c]{-5.11\\(5.27)} & \makecell[c]{-6.05\\(4.17)} & \makecell[c]{-11.55\\(8.14)} \\
